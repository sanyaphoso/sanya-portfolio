      ...
      <Container maxWidth="lg">
        <StyledToolbar variant="dense" disableGutters>
          <Box sx={{ flexGrow: 1, display: 'flex', alignItems: 'center', px: 0 }}>
            <Button component={Link} to="/" variant="text" color="blue">
              SANYA
            </Button>
            <Box sx={{ display: { xs: 'none', md: 'flex' } }}>
              ...
              <Button component={Link} to="/portfolio" variant="text" color="info" size="small">
                Portfolio
              </Button>
              <Button component={Link} to="/contact" variant="text" color="info" size="small">
                Contact
              </Button>
          ...
          <Box sx={{ display: { xs: 'flex', md: 'none' }, gap: 1 }}>
            ...
            >
              <Box sx={{ p: 2, backgroundColor: 'background.default' }}>
                ...
                <MenuItem component={Link} to="/">Resume</MenuItem>
                <Divider sx={{ my: 3 }} />
              </Box>
            </Drawer>
          </Box>
